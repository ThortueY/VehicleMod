...
public class KartEntity extends BaseVehicleEntity {
    ...
    protected void initSlots() {
        // Le Moteur
        this.addSlot("engine_bay", new PartSlot("engine_bay", new Vec3(0, 0.5, -1.0), 0.8f, 0.8f, new EngineBayInteraction(), PartCategory.KART_ENGINE));
        // Les 4 Roues
        this.addSlot("wheel_front_left", new PartSlot("wheel_front_left", new Vec3(1.0, 0.2, 1.0), 0.5f, 0.5f, new WheelInteraction(), PartCategory.KART_WHEEL));
        this.addSlot("wheel_front_right", new PartSlot("wheel_front_right", new Vec3(-1.0, 0.2, 1.0), 0.5f, 0.5f, new WheelInteraction(), PartCategory.KART_WHEEL));
        this.addSlot("wheel_back_left", new PartSlot("wheel_back_left", new Vec3(1.0, 0.2, -1.0), 0.5f, 0.5f, new WheelInteraction(), PartCategory.KART_WHEEL));
        this.addSlot("wheel_back_right", new PartSlot("wheel_back_right", new Vec3(-1.0, 0.2, -1.0), 0.5f, 0.5f, new WheelInteraction(), PartCategory.KART_WHEEL));
